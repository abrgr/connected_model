        ...
        return getDb(context, function(db) {
            return new P(function(resolve, reject) {
                ...
                query.execute(function(error, result) {
                    ...
                    if ( !!result.warnings ) {
                        // TODO: log warnings
                        return reject(new Error(result.warnings + ' Warnings in delete'));
                    }
        ...
        return getDb(this, function(db) {
            return new P(function(resolve, reject) {
                ...
                if ( deleteMarkerProperty ) {
                    ...
                    var deleteFieldsAndNames = getFieldValues(deleteSetter, true),
                        deleteFieldNames = deleteFieldsAndNames.map(function(fieldValue) { return fieldValue.field; }),
                        deleteFieldValues = deleteFieldsAndNames.map(function(fieldValue) { return fieldValue.fieldValue; });
