    ...
    var singleRowToModel = model._singleRowToModel = function(db, row) {
        ...
        Object.keys(row).forEach(function(alias) {
            ...
            if ( !!fieldName ) { 
                ...
                fieldName = fieldName.split('.').reverse()[0]; 
            }            
            ...
            if ( _.isUndefined(propName) ) {
                ...
                // propName is a property on this model
                field = options.fields[propName];
            }
        ...
        return getDb(this, function(db, deferred) {
            ...
            Deferred.afterAll(manyToManyDeferreds).success(function(results) {
                ...
                manyToManyProperties.forEach(function(property) {
                    var currentVals = _.pluck(_.filter(resultsAndProperties, function(rAndP) { return rAndP.property === property; }),
                                              'currentVals').reduce(function(a, b){return a.concat(b);}, []);
                    ...
                    var deleteDeferreds = toDelete.map(function(deleteMe){ return thatModel.prototype.delete.call(deleteMe); });
                    var addDeferreds = toAdd.map(function(addMe) { return thatModel.prototype.insert.call(addMe); });
